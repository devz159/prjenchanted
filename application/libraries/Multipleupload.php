...
class Multipleupload {
	...
	public function  do_upload($file = 'userfile') {
		...
		foreach($this->FILES as $key => $val):
			...
			$config['new_image'] = $this->_mFields['upload_path'] . 'thumbs/' . (isset($this->_mFields['file_name']) ?  $this->_mFields['file_name'] . $this->CI->upload->file_ext : $_FILES[$file]['name']); // $_FILES[$file]['name']; @neerevisit: changed from default filename into customed name
			...
			if($this->_mFields['create_thumbs'] == 'true'):
