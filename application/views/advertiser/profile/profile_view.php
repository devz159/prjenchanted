...
<?php foreach($userprofile as $up): ?>
    ...
    <p><label>Address<span class="reqfld">*</span> </label> <input type="text" name="address" value="<?php echo $up->address; ?>" /><?php echo form_error('address', '<span class="error">', '</span>'); ?></p>
...
<p>
  <label>Primary Phone<span class="reqfld">*</span> </label>
   <input type="text" name="phone" value="<?php echo $up->phone; ?>" /><?php echo strTruncate(form_error('phone', '<span class="error">', '</span>'), 45); ?></p>
    <p><label>Secondary Phone</label> <input type="text" name="phone2" value="<?php echo $up->phone2; ?>" /></p>
    <p><label>Email<span class="reqfld">*</span> </label> <input type="text" name="email" value="<?php echo $up->email; ?>" /><?php echo display_error('email'); ?></p>
    ...
    <p><input class="submitbtn" type="submit" value="Save My Profile" /></p>
<?php endforeach; ?>
<?php echo form_close(); ?>
</div>